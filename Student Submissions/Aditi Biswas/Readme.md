...
Identify high-priority issues affecting support efficiency.

Understand ticket distribution across customer segments and regions.
...
├── data
│   ├── raw
│   │   └── synthetic_it_support_tickets.zip
│   │
│   └── processed
